...
function initInteractiveCube() {
    ...
    // ── TACHYONIC ENGINE — Hypercube Interior ──
    // Extracted to tachyonic.js — self-contained 3D void renderer
    // Triple-click → the UI vanishes. You're inside.
    TachyonicEngine.init({
        cubeContainer,
        onExit: () => {
